...
function submit()
{
    ...
    var length_guest_array=name_of_the_guest_array.length;
    console.log(length_guest_array);

    for(var k=0;k<length_guest_array;k++)
    {
...
function sorting()
{
    ...
    var length_guest_array_1=name_of_the_guest_array.length;
    console.log(length_guest_array_1);
    
    for (var k = 0; k < length_guest_array_1; k++) 
